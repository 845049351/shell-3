...
class Tree {
	...
	public static function niunum($n) {
	...
	public static function unionArray($a, $b) {
...
print_r(Tree::changeArr(array(12, 34, 56, 32)));

print_r(Tree::unionArray(array(1, 2, 4, 5, 's'), array(2, 5, 7, 'c', 'd'))) . "\n";
